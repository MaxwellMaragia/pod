...
<div class="container">
	<div class="row" style="margin-top:-20px">
		...
		<!-- Content -->
		<div class="col-xl-8 col-lg-7 content-right-offset">
			<!-- Tabs Container -->
			<div class="tabs">
				<div class="tabs-header" style="background:#033155;">
					<ul>
						<li class="active"><a href="#tab-1" data-tab-id="1"><i class="icon-line-awesome-question"></i> Instructions</a></li>
						<li><a href="#tab-2" data-tab-id="2"><i class="icon-line-awesome-download"></i> Files</a></li>
						<li><a href="#tab-3" data-tab-id="3"><i class="icon-line-awesome-upload"></i> Answer(s)</a></li>
					</ul>
		...
		<div class="tabs-content">
				...
				<div class="tab" data-tab-id="2">
					...
					<a href="#" class="attachment-box ripple-effect"><span>Project Brief.docx</span><i>DOCX</i></a>
				...
				<div class="tab" data-tab-id="3">
					...
					<span class="uploadButton-file-name">Click pin to upload</span>
					</div>
		...
		<div class="col-xl-4 col-lg-4">
			...
			<div class="tabs">
				...
				<!-- Tab header -->
					<div class="tabs-header" style="background:#033155">
						<ul>
							<li class="active"><a href="#tab-1" data-tab-id="1"> <i class="icon-feather-message-square"></i> Client <i class="dot"></i></a></li>
							<li><a href="#tab-2" data-tab-id="2"> <small class="icon-feather-message-square"></small> Supp</a></li>
						</ul>
					  <div class="tab-hover"></div>
					  <nav class="tabs-nav">
						  <span class="tab-prev"><i class="icon-material-outline-keyboard-arrow-left"></i></span>
